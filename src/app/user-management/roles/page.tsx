...
const RolesPage: React.FC = () => {
    ...
    const [roles, setRoles] = useState<{ code: string; role_name: string; active: string; }[]>([]);
    ...
    const handleLoadRoles = () => {
        ...
        .then((response) => {
            ...
            if (Array.isArray(response.data)) {
                ...
                console.error("Expected an array in response.data, but received:", response);
            }
        })
        .finally(() => {
                            ...
                            <tbody>
                                {roles.map((role, key) => (
                                    <tr key={key} className='text-center'>
                                        ...
                                        <td className="border-b border-[#eee] dark:border-strokedark">
                                            <p
                                                className={`inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium ${role.active === "Y"
